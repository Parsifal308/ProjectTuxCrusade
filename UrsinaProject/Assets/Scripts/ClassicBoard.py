...
class classicBoard(IBoard):
    ...
    def SetPieces(self):  # settea las piezas en la parte [x, y, 1] de la matriz
        ...
        self.positions[0, 3, 1] = King('white', Vec3((0, 3, 0.5)), 0.5, 90, 90, 90)
        self.positions[0, 4, 1] = Queen('white', Vec3((0, 4, 0.5)), 0.5, 90, 90, 90)
        ...
        self.positions[7, 3, 1] = King('black', Vec3((7, 3, 0.5)), 0.5, -90, 0, 0)
        self.positions[7, 4, 1] = Queen('black', Vec3((7, 4, 0.5)), 0.5, -90, 0, 0)
